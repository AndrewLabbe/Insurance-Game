...
**ClaimCraft** is an interactive narrative-driven insurance simulation game built in Unity. Players take on the role of an insurance agent navigating a complex world of policy approvals, claim investigations, and ethical dilemmas. Designed to both educate and engage, ClaimCraft blends exploration, decision-making, and real-world insurance logic into one immersive experience.
...
- **Platform:** PC (Unity)
- **Genre:** Simulation / Narrative / Puzzle
- **Focus:** Auto and home policy management, fraud detection, ethical decision-making
- **Key Features:**
